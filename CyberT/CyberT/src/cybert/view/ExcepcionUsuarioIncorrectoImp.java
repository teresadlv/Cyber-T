...
public class ExcepcionUsuarioIncorrectoImp  extends JDialog{
	/**
	 * 
	 */
	...
	public ExcepcionUsuarioIncorrectoImp() {
		initGUI();
	}
	...
	private void create_text() {
		textoInformativo = new JLabel("<html><div style='text-align: center;'>El usuario introducido no existe</div></html>");
		textoInformativo.setFont(new Font("Arial", Font.BOLD, 18));
